params = load("C:\Users\xseri\Documents\MATLAB\params_2023_02_01__13_25_30.mat");

lgraph = layerGraph();

tempLayers = [
    imageInputLayer([224 224 3],"Name","ImageInput","Normalization","zscore","Mean",params.ImageInput.Mean,"StandardDeviation",params.ImageInput.StandardDeviation)
...
tempLayers = [
    ...
    fullyConnectedLayer(2,"Name","fc","Bias",params.fc.Bias,"Weights",params.fc.Weights)
